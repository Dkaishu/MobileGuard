...
import com.fang.mobileguard.db.dommain.AppInfo;
import com.fang.mobileguard.engine.AppInfoProvider;
        ...
        switch (v.getId()) {
            case R.id.tv_uninstall:
                if(mAppInfo.isSystem){
                    TastyToast.makeText(getApplicationContext(),"此应用不能卸载",
            ...
            case R.id.tv_start:
                ...
                if(launchIntentForPackage!=null){
                    ...
                    TastyToast.makeText(getApplicationContext(),"此应用不能被开启",
                            TastyToast.LENGTH_SHORT,TastyToast.WARNING);
                }
                break;
